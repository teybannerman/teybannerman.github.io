...
**For speaking enquiries:** [john@chartwellspeakers.com](mailto:john@chartwellspeakers.com)
...
<ul class="post-list">
	<li>
		<h4>The Four Modes: how leaders actually work with AI</h4>
	...
	<li>
		<h4>Cultural intelligence: why your AI works in Berlin and fails in São Paulo</h4>
	...
	<li>
		<h4>The trust gap: designing AI that people actually use</h4>
	...
	<li>
		<h4>Leadership when the tools change everything</h4>
