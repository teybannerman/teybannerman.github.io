---
layout: page
strapline: Tiny Lab of Wonders
permalink: /tiny-lab/
---

Small creations, experiments, and tools. Built from curiosity, not commercial ambition.
...
<div class="ideas-grid">
  <div class="idea-card">
    <h4>Coming soon</h4>
    <p>Small tools, experiments, and creations are in the works. Check back soon to see what's being built in the lab.</p>
  </div>
</div>
